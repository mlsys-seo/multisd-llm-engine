...
class Qwen3FlashInferAttention(Qwen3Attention):
    ...
    def forward(
        ...
        # print(f"  key_states: {key_states.shape}")
        # print(f"  value_states: {value_states.shape}")
        # print(f"  batch_indices: {flashinfer_metadata.batch_indices}")
        # print(f"  positions: {flashinfer_metadata.positions}")
        # print(f"  paged_kv_indices: {flashinfer_metadata.paged_kv_indices.shape}")
        # print(f"  paged_kv_indptr: {flashinfer_metadata.paged_kv_indptr.shape}")
        # print(f"  paged_kv_last_page_len: {flashinfer_metadata.paged_kv_last_page_len.shape}")
        # print(f"  past_key_value: {past_key_value.shape}")
        # print(f"  kv_indices: {self.config.prefill_wrapper._paged_kv_indices_buf}")
        # print(f"  kv_indptr: {self.config.prefill_wrapper._paged_kv_indptr_buf}")
        # print(f"  kv_last_page_len: {self.config.prefill_wrapper._paged_kv_last_page_len_buf}")
        # print(f"  num_all_tokens: {flashinfer_metadata.num_all_tokens_tensor}")
        # print(f"----------------------------------------------------------------")
